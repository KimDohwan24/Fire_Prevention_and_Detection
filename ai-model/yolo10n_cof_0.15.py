...
TRAIN_RUN_NAME = "fire_yolov10n"

TEST_RUN_NAME = "fire_yolov10n_test_conf020"


# ============================================================
# 기존 Epoch 10 BEST MODEL
# ============================================================

# 재학습 없이 아래 best.pt를 불러와 TEST 평가만 수행합니다.
BEST_MODEL_PATH = (
    RUNS_DIR
    / TRAIN_RUN_NAME
    / "weights"
...
def main():
    ...
    print()
    print("=" * 70)
    print("YOLOv10n Epoch 10 BEST.PT / CONF 0.20 TEST 평가")
    print("=" * 70)
    ...
    # --------------------------------------------------------
    # 기존 Epoch 10 BEST MODEL 사용
    # 재학습하지 않고 TEST 평가만 수행
    # --------------------------------------------------------
    ...
    if not best_model_path.exists():
        raise FileNotFoundError(
            f"기존 best.pt를 찾을 수 없습니다: {best_model_path}"
        )

    print()
    print("[기존 BEST MODEL 사용]")
