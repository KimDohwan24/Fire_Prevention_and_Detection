...
TRAIN_RUN_NAME = "CCS_final_0825"

TEST_RUN_NAME = "CCS_final_0825_test"
...
# ============================================================
#
# yolo_augmentation_experiments.py에서
# EXP6 + EXP4 조합이 최고 성능으로 검증되었고,
# 그 final 스테이지 학습 레시피를 그대로 사용합니다.
#
# ============================================================

# 최종 학습은 YOLO11m 사용 (실험 프레임워크 final 규격)
...
#
# yolo_augmentation_experiments.py의 EXP4 + EXP6 승리 조합:
#
#   EXP4 (화질 열화 시뮬레이션)
#   - ImageCompression         : JPEG 압축 아티팩트
#   - GaussNoise               : 센서 노이즈
#   - GaussianBlur             : 초점 흐림
#   - RandomBrightnessContrast : 밝기/대비 변화
#
#   EXP6 (가림 재현)
#   - CoarseDropout            : 객체 일부 가림(occlusion)
#
# ============================================================
...
def print_experiment_settings():
    ...
    print()
    print("=" * 70)
    print("CCS Final 학습 설정 (YOLO11m / EXP4+EXP6)")
    print("=" * 70)
    ...
    print(
        "JPEG 압축        : q=60~90, p=0.40"
    )

    print(
        "Gaussian Noise   : std=0.005~0.025, p=0.20"
    )

    print(
        "Gaussian Blur    : k=3, p=0.15"
    )

    print(
        "음영/밝기/대비   : 밝기 ±15%, 대비 ±10%, p=0.25"
    )
    ...
    print(
        "CoarseDropout    : 1~4개 구멍, p=0.25"
    )

    print(
        f"Scale            : ±{int(0.20 * 100)}%"
    )

    print(
        f"Translate        : ±{int(0.05 * 100)}%"
    )
...
def train_model(
    ...
    print()
    print("=" * 70)
    print("YOLO11m 학습 시작 (EXP4 + EXP6 최적 조합)")
    print("=" * 70)
...
def main():
    ...
    print()
    print("=" * 70)
    print("CCS Final 화재 / 연기 / Background 학습 및 평가")
    print("=" * 70)
