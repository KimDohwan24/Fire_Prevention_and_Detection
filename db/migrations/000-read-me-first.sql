...
--      |                                               | 다른 DB 에서는 no-op 이다.
--  -----------------------------------------------------------------------------
--  005 | 2026-08-14-user-activity                      | user_activity 테이블 신설
--      |                                               | (접속·로그아웃 등 활동 이력)
--  -----------------------------------------------------------------------------
--  006 | 2026-08-17-activity-detail-and-social         | 활동이력 상세(target·detail),
--      |                                               | 토큰 폐기 기준 시각,
--      |                                               | 소셜 로그인 컬럼
--  -----------------------------------------------------------------------------
--  007 | 2026-08-18-report-dispatch-and-cctv-address   | 소방서 출동 통지 컬럼
--      |                                               | (report_dispatched_at·report_dispatch),
--      |                                               | cctv_address 컬럼,
--      |                                               | 진행중 정의에 DISPATCHED 추가
--      |                                               | ⚠️ 001 이 폐기한 DISPATCHED 를
--      |                                               |    다른 뜻으로 되살린다 (파일 머리말 참고)
--  -----------------------------------------------------------------------------
--  008 | 2026-08-21-agency-source-address-phone        | agency 에 컬럼 3개 —
--      |                                               | 출처 고유번호·주소·전화 +
--      |                                               | 출처 고유번호 부분 유니크 인덱스.
--      |                                               | 같은 이름의 소방서가 전국에
--      |                                               | 여럿이라(중부소방서 5곳 등)
